 ...
 */
export const DesktopEditor: React.FC<EditorProps> = ({ note, onUpdateTags, onRestore, onDelete }) => {
              ...
              {isTrashSelected ? (
                <>
                  <button 
                    ...
                    className="p-2 text-blue-400 hover:text-blue-300 transition-colors bg-blue-400/10 rounded-lg flex items-center gap-2 px-3 text-sm font-medium"
                    title="Restore Note"
                  >
                  ...
                  <button 
                    ...
                    className="p-2 text-red-500 hover:text-red-400 transition-colors bg-red-400/10 rounded-lg flex items-center gap-2 px-3 text-sm font-medium"
                ...
                <button 
                  onClick={() => onDelete?.(note.id)}
                  className="p-2 text-slate-500 hover:text-red-400 transition-colors bg-slate-800/20 rounded-lg flex items-center gap-2 px-3 text-sm font-medium"
                  title="Move to Trash"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-trash-2"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/><line x1="10" x2="10" y1="11" y2="17"/><line x1="14" x2="14" y1="11" y2="17"/></svg>
                  Delete
